...
{
    public class UpdatePasswordCommandHandler : ICommandHandler<UpdatePasswordCommand, string>
    {
        private readonly UserRepository _repository;
        public UpdatePasswordCommandHandler(UserRepository repository) => _repository = repository;

        public Task<Result<string>> Handle(UpdatePasswordCommand request, CancellationToken cancellationToken)
        {
