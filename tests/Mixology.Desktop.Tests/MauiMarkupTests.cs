...
public sealed class MauiMarkupTests
{
    ...
    {
        XDocument project = XDocument.Load(ProjectPath("Mixology.Desktop.csproj"));
    ...
    {
        string root = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../../src/Mixology.Desktop"));
