...
(
    ...
    [UpdatedBy]        VARCHAR (32)     CONSTRAINT [UserAccess_UserPassword_UpdatedBy] DEFAULT (SUSER_SNAME()) NOT NULL,
    [UpdatedOn]        DATETIME2        CONSTRAINT [UserAccess_UserPassword_UpdatedOn] DEFAULT (GETDATE()) NOT NULL,
